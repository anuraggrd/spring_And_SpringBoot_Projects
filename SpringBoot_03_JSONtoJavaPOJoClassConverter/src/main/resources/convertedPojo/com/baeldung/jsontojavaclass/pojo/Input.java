...
public class Input {
    ...
    public Input withItem(Integer item) {
        this.item = item;
        return this;
    }
    ...
    public Input withAmount(Integer amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Input withRegularPrice(Double regularPrice) {
        this.regularPrice = regularPrice;
        return this;
    }
    ...
    public Input withItemState(String itemState) {
        this.itemState = itemState;
        return this;
    }
    ...
    public Input withCouponApplicable(Boolean couponApplicable) {
        this.couponApplicable = couponApplicable;
        return this;
    }
